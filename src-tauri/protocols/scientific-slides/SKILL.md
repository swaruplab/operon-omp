...
3. **Default author is "Operon"** unless another name is specified
...
python scripts/generate_slide_image.py "Title slide for presentation: 'Machine Learning: From Theory to Practice'. Subtitle: 'AI Conference 2025'. Speaker: Presenter. FORMATTING GOAL: Dark blue background (#1a237e), white text, gold accents (#ffc107), minimal design, sans-serif fonts, generous margins, no decorative elements." -o slides/01_title.png
...
2. **Generate Slides with Nano Banana Pro** (1-2 hours):
   ...
   **Important: Use consistent formatting, attach previous slides, and include citations!**
   ...
   ```bash
   # Title slide (establishes style - default author: Operon)
   python scripts/generate_slide_image.py "Title slide: 'Your Research Title'. Conference name, Presenter. FORMATTING GOAL: [your color scheme], minimal professional design, no decorative elements, clean and corporate." -o slides/01_title.png
